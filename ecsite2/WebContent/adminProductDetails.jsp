...
<!-- ここ在庫数に修正必要 -->
		...
		<div class="admin_change">
			...
			<s:submit value="この商品の情報を更新する" class="admin_change_btn" />
			</s:form>

			<s:form action="ProductDetailsAction">
			<input type="hidden" name="deleteFlg" value="1">
			<s:submit value="この商品情報を削除する" class="admin_change_btn"/>
			</s:form>
		</div>
	...
	<div class="box">
		<div class="product-details-recomｍend-box">
			<s:iterator value="#session.productInfoDtoList">
				...
				<s:param name="productId" value="%{productId}"/></s:url>'><img src='<s:property value="imageFilePath"/>/<s:property value="imageFileName"/>' class="item-image-box-100"/></a>
