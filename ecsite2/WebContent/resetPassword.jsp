	...
	<div id="contents">
		...
		<s:if test="!#session.passwordIncorrectErrorMessageList.isEmpty()">
			<div class="error">
				<div class="error-message">
					<s:iterator
						value="#session.passwordIncorrectErrorMessageErrorMessageList">
						<s:property />
						<br>
					</s:iterator>
				</div>
		...
		<s:if test="!#session.newPasswordIncorrectErrorMessageList.isEmpty()">
			<div class="error">
				<div class="error-message">
					<s:iterator
						value="#session.newPasswordIncorrectErrorMessageErrorMessageList">
						<s:property />
						<br>
					</s:iterator>
				</div>
		...
		<s:form action="ResetPasswordConfirmAction">
			...
			<s:submit value="パスワード再設定" class="subimit_btn" />
		</s:form>
	</div>
