...
public class NewUserConfirmAction extends ActionSupport implements SessionAware {
	...
	public String execute() {
		...
		if (!(familyName.equals("")) && !(firstName.equals("")) && !(familyNameKana.equals(""))
				&& !(firstNameKana.equals("")) && !(sex.equals("")) && !(email.equals("")) && !(loginId.equals(""))
				&& !(password.equals(""))) {
//全ての入力項目がブランクでなければ、セッションに値を入れる
