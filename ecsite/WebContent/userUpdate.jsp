...
<body>
	...
	<div id="main">
		...
		<s:form action="UserUpdateConfirmAction">
			...
			<div>
				<label>新しいログインID</label> <br> <input type="text"
					name="loginUserId" value="" size="15" class="update" /><br>
			</div>
			<br>

			<div>
				<label>新しいログインパスワード</label> <br> <input type="text"
					name="loginPass" value="" size="15" class="update" /><br>
			</div>
			<br>

			<div>
				<label>新しいユーザー名</label> <br> <input type="text" name="userName"
					value="" size="15" class="update" /><br>
			</div>
			<br>
			<div>
