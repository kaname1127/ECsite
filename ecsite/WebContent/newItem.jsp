			...
			<div id="admin">
				<div class="new">
					...
					<s:form action="ItemCreateConfirmAction">
						<div>
							<label>新商品名</label> <br> <input type="text" name="itemName"
								value="" size="40" class="update" placeholder="新商品名を入力して下さい" />
							<br>
						</div>
						<br>

						<div>
							<label>新商品値段</label> <br> <input type="text"
								name="itemPrice" value="" size="30" class="update"
								placeholder="新商品の値段を入力して下さい" /><br>
						</div>
						<br>

						<div>
							<label>在庫数</label> <br> <input type="text" name="itemStock"
								value="" size="25" class="update" placeholder="在庫数を入力して下さい" /><br>
						</div>
						<br>
